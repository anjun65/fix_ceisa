                        ...
                        {{-- <div class="py-4 space-y-4"> --}}
                                ...
                                <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
                                    <ul class="flex flex-wrap -mb-px">
                                        <li class="mr-2">
                                            <a href="{{ route('admin-edit-pabean', $nomor_aju_pabean )}}" class="inline-block p-4 text-blue-600 rounded-t-lg border-b-2 border-blue-600 active dark:text-blue-500 dark:border-blue-500" aria-current="page">Header</a>
                                        </li>
                                        <li class="mr-2">
                                                ...
                                                <div class="bg-white rounded shadow hover:shadow-md duration-4">
                                                    ...
                                                    <div class="grid grid-cols-4 gap-2">
                                                        ...
                                                        <div class="px-6 pt-6 text-grey-darker text-justify flex flex-col">
                                                            ...
                                                            <x-input.select disabled name="kantor_aju_pabean" id="kantor_aju_pabean">
